...
module Rubicons
  ...
  autoload :Iconoir, 'rubicons/iconoir'
  autoload :Ionicons4, 'rubicons/ionicons4'
  autoload :Ionicons5, 'rubicons/ionicons5'
  autoload :LineAwesome, 'rubicons/line_awesome'
  autoload :Lineicons, 'rubicons/lineicons'
  autoload :Lucide, 'rubicons/lucide'
  autoload :Majesticons, 'rubicons/majesticons'
  autoload :MaterialDesign, 'rubicons/material_design'
  autoload :MaterialSymbols, 'rubicons/material_symbols'
  autoload :MingCute, 'rubicons/ming_cute'
  autoload :MynaUiIcons, 'rubicons/myna_ui_icons'
  autoload :Octicons, 'rubicons/octicons'
  autoload :PhosphorIcons, 'rubicons/phosphor_icons'
  autoload :Pixelarticons, 'rubicons/pixelarticons'
