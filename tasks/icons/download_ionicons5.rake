...
namespace :icons do
  ...
  task :download_ionicons5 do
    puts 'Downloading Ionicons 5 from GitHub zip...'

    # Create the destination directory
    icons_dir = File.join('icons', 'ionicons5')
    FileUtils.mkdir_p(icons_dir)

    # Temporary location for the zip file
    temp_zip = File.join(Dir.tmpdir, 'ionicons5.zip')
    ...
    begin
      ...
      puts "Successfully extracted #{icon_count} Ionicons 5 icons to #{icons_dir}"
