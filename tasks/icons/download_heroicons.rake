...
namespace :icons do
  ...
  task :download_heroicons do
    puts 'Downloading Heroicons v1 from GitHub zip...'

    # Create the destination directory
    icons_dir = File.join('icons', 'heroicons')
    FileUtils.mkdir_p(icons_dir)

    # Temporary location for the zip file
    temp_zip = File.join(Dir.tmpdir, 'heroicons1.zip')
    ...
    begin
      ...
      puts "Successfully extracted #{icon_count} Heroicons v1 icons to #{icons_dir}"
